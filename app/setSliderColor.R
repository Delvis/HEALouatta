...
setSliderColor <- function(color, sliderId) {
  ...
  sliderCol <- lapply(sliderId, FUN = function(i) {
    # We target the bar (the fill), the handle (from/to), and the line
    paste0(
      ".js-irs-", i, " .irs-bar { background: ", color[i+1], " !important; border-top: 1px solid ", color[i+1], " !important; border-bottom: 1px solid ", color[i+1], " !important; } ",
      ".js-irs-", i, " .irs-bar-edge { background: ", color[i+1], " !important; border: 1px solid ", color[i+1], " !important; } ",
      ".js-irs-", i, " .irs-single, .js-irs-", i, " .irs-from, .js-irs-", i, " .irs-to { background: ", color[i+1], " !important; } ",
      ".js-irs-", i, " .irs-handle i, .js-irs-", i, " .irs-handle:hover i { background: ", color[i+1], " !important; } "
    )
  })
